...
/* console.log(`La moyenne du troisième match pour les ${teamDauphins} est de: ${thirdMatchDauphinsAverageScores}`); */
...
/* console.log(`La moyenne du troisième match pour les ${teamKoalas} est de: ${thirdMatchKoalasAverageScores}`); */
...
if(firstMatchDauphinsAverageScores > 100 || firstMatchKoalasAverageScores > 100) {
    ...
    console.log(`Aucune équipe n'a obtenue 100 pts`)
}
